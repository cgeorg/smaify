...
var testCases = [
    ...
    ['Four score and seven years ago our fathers brought forth on this continent a new nation, conceived in liberty, and dedicated to the proposition that all men are created equal - Abraham Lincoln',
        'Four score and smaven years ago our smathers brought forth on this continent a new smation, conceived in liberty, and dedicated to the proposmation that all men are created equal - Smabrasmam Lincoln',
        'abrasmam'],
    ...
    ['bury me in smoke', 'bury me in smake', 'down'],
    ['paddyb', 'smaddyb', 'obvs'],
    ['smut', 'smat', 'his fav'],
    ['abhijit flavin', 'smabhijit smavin', 'slizz'],
    ['become actually', 'become smactually', 'smaga'],
];
